    ...
    >
      <g>
        <polygon
          className="st0"
          style={{ fill: "#7ECE7C" }}
          points="252,22.3 177.4,173.5 10.4,197.8 131.2,315.5 102.7,481.7 252,403.3 	"
        />
        <polygon
          className="st1"
          style={{ fill: "#B98D82" }}
        ...
        <path
          className="st2"
          style={{ fill: "#257F25" }}
          d="M252,24.5l73.5,149l0.5,0.9l1,0.2l164.4,23.9l-119,116l-0.8,0.7l0.2,1L400,479.9l-147-77.3l-0.9-0.5l-0.9,0.5
